...
from handlers.admin_handlers import delete_messages, warn_user, mute_user, ban_user , kick_user,statusM,unmute_user
from handlers.user_handlers import start, help_command, check_reputation, monitor_user, status, test_command, welcome_new_member
...
class GroupManagerBot:
    ...
    def setup_handlers(self):
        ...
        self.application.add_handler(CommandHandler("status", statusM))
